...
class Woocategory extends AbstractBlock {
	...
	private function render_category( $preset_type, array $attributes, $cata, $class_names ) {
		...
		switch ( $preset_type ) {
			case 'two':
				return sprintf(
					'<a href="%4$s" class="oop-woo__category-card-content op-woo__category-pre2 op-woo__category-card %5$s">
						<figure>
			...
			case 'three':
				return sprintf(
					'<a href="%4$s" class="op-woo__category-pre3 op-woo__card op-woo__category-card %5$s" title=" %3$s">
			...
			default:
				return sprintf(
					'<a href="%4$s" class="op-woo__category-pre1 op-woo__card op-woo__category-card %5$s">
						<figure>
							<img class="op-woo__category-image" src=" %3$s" alt=" %1$s" />
						</figure>
