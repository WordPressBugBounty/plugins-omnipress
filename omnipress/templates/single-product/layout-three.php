...
<div class="op-single-product-meta">
	...
	?>
	<div class="product-meta-button-group">
		<?php do_action( 'single_product_before_add_to_cart' ); ?>
		<?php echo $woo_fields->render_add_to_cart( 'op-add-to-cart-button-wrap' ); ?>
		<?php do_action( 'single_product_after_add_to_cart' ); ?>
	</div>
</div>
